---
title: "Exploring the Cybersecurity Domains: A Comprehensive Guide"
date: 2024-02-02
authors:
  - name: "0xrh0d4m1n"
...
<figure>
  <img src="/img/posts/b4ecfe1cc9caacd4d04fedb38303bb35.jpeg" alt="Cybersecurity Domains" style="width:100%;">
</figure>
...
Security architecture forms the bedrock of an organization's cybersecurity defenses. It is a holistic blueprint that outlines how cybersecurity measures are integrated within the information technology environment to safeguard data and assets from cyber threats.
...
Governance in cybersecurity is an overarching framework that ensures all security efforts align with the organization's objectives and adhere to compliance standards.

### Laws and Regulations

Compliance with laws and regulations is paramount in cybersecurity governance:

- **General Data Protection Regulation (GDPR)**: EU regulation on data protection and privacy.
- **Health Insurance Portability and Accountability Act (HIPAA)**: US regulation for safeguarding medical information.
- **Payment Card Industry Data Security Standard (PCI DSS)**: Mandating security measures for organizations handling credit card transactions.

### Executive Management Involvement

Cybersecurity requires active engagement from executive management:

- **Setting the Tone at the Top**: Demonstrating that cybersecurity is a priority.
- **Decision-Making**: Senior leaders involved in critical cybersecurity decisions.
- **Risk Appetite Definition**: Management sets the acceptable level of risk.

---

## **Risk Management in Cybersecurity**

Enterprise Risk Management (ERM) is a strategic business discipline that addresses the full spectrum of risks a firm faces, including cybersecurity risks.

### Risk Treatment Actions

- **Avoidance**: Ceasing the activities that generate risk.
...
- **Business Continuity Planning**: Identifying key products or services and planning how the business will continue to deliver them in the event of a crisis.
- **Disaster Recovery**: Focusing on restoring data access and IT infrastructure essential for delivering the critical activities of the firm.
...
The NIST Cybersecurity Framework offers a comprehensive set of voluntary guidelines for managing cybersecurity-related risks. Its core functions — Identify, Protect, Detect, Respond, and Recover — create a strategic view of the lifecycle of an organization's management of cybersecurity risk.

### MITRE ATT&CK Framework

A globally-accessible knowledge base of adversary tactics and techniques observed from real-world cyberattacks. Security teams use this framework to better understand security risks, improve threat detection, and enhance their incident response strategies.

### ISO 27001 Framework

An international standard that provides the specification for an information security management system (ISMS). It helps organizations in any sector keep information assets secure.

### OWASP TOP 10 (WebApp & API)

A standard awareness document representing the most critical security risks to web applications and APIs.

### CIS TOP 20 Controls (CIS Benchmarks)

A prioritized set of best practices designed to provide actionable ways to stop today's most pervasive and dangerous cyberattacks.
...
- **Identification**: Tools and processes to discover existing vulnerabilities.
- **Classification and Prioritization**: Categorizing vulnerabilities based on severity.
- **Remediation and Mitigation**: Addressing the most critical vulnerabilities first.

### Threat Hunting

Threat hunters proactively sift through networks and datasets to detect anomalies, generate hypotheses about potential threats, and investigate findings.

### Security Operation Center (SOC)

A SOC serves as the central hub for monitoring and analyzing an organization's security posture on an ongoing basis — 24/7 monitoring, event analysis, coordination, and continuous improvement.

### SIEM/SOAR

- **SIEM**: Comprehensive data collection, normalization, analysis, and reporting to provide real-time visibility.
- **SOAR**: Automating routine tasks, orchestrating complex workflows, and enabling swift response to incidents.
...
<figure>
  <img src="/img/posts/0fcd29f3028933f3d043bea937c4d5cd.png" alt="Map of Cybersecurity Domains" style="max-height:500px; display:block; margin:auto;">
</figure>
